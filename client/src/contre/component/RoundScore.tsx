  ...
  const data = [
    {
      ...
      partner: roundScore?.TeamsResult[partnerTeamID]?.CardsPoints,
      opponent: roundScore?.TeamsResult[opponentTeamID]?.CardsPoints,
    },
    {
      key: 'ExtraPoints',
      description: i18n.Score.extraPoints,
      partner: roundScore?.TeamsResult[partnerTeamID]?.ExtraPoints,
      opponent: roundScore?.TeamsResult[opponentTeamID]?.ExtraPoints,
    },
    {
      key: 'BelotAnnouncePoints',
      description: i18n.Score.belotAnnouncePoints,
      partner: roundScore?.TeamsResult[partnerTeamID].BelotAnnouncePoints,
      opponent: roundScore?.TeamsResult[opponentTeamID]?.BelotAnnouncePoints,
    },
    {
      key: 'TotalPoints',
      description: i18n.Score.totalPoints,
      partner: roundScore?.TeamsResult[partnerTeamID].TotalPoints,
      opponent: roundScore?.TeamsResult[opponentTeamID].TotalPoints,
    },
    {
      key: 'RoundedTotalPoints',
      description: i18n.Score.roundedTotalPoints,
      partner: roundScore?.TeamsResult[partnerTeamID].RoundedTotalPoints,
      opponent: roundScore?.TeamsResult[opponentTeamID].RoundedTotalPoints,
    },
  ];
